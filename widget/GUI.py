...
class MainWindow(QWidget):
    def __init__(self, node_1, node_2, x_axis, y_axis):
        ...
        user_bar = UserBar()
        tab_widget = TabWidget(node_1, node_2, x_axis, y_axis)
...
class TabWidget(QTabWidget):
    def __init__(self, node_1, node_2, x_axis, y_axis):
        ...
        self.user_group = UserGroup(node_1, node_2, x_axis, y_axis)
        user_layout.addWidget(self.user_group)
        self.user_tab.setLayout(user_layout)

        dev_layout = QVBoxLayout()
        self.dev_group = DevGroup(node_1, node_2, x_axis, y_axis)
...
class UserGroup(QWidget):
    def __init__(self, node_1, node_2, x_axis, y_axis):
        ...
        self.hand_user = HandUser(self.node_1, self.node_2)
        self.arm_user = ArmUser(self.x_axis, self.y_axis)
...
class DevGroup(QWidget):
    def __init__(self, node_1, node_2, x_axis, y_axis):
        ...
        self.hand_dev = HandDev(self.node_1, self.node_2)
        self.arm_dev = ArmDev(self.x_axis, self.y_axis)
